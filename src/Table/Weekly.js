...
const Weekly = (props) => {
    ...
    {
        let newData = { 'monday': { 'hrs': 0, 'min': 0 }, 'tuesday': { 'hrs': 0, 'min': 0 }, 'wednesday': { 'hrs': 0, 'min': 0 }, 'thursday': { 'hrs': 0, 'min': 0 }, 'friday': { 'hrs': 0, 'min': 0 }, 'saturday': { 'hrs': 0, 'min': 0 } };
        let rowData = [{ 'monday': '', 'tuesday': '', 'wednesday': '', 'thursday': '', 'friday': '', 'saturday': '', 'total': '' }];
        ...
        {                        
            ...
            if(idx!==-1)
            {
                ...
                tm += parseInt(wh[0]*60) + parseInt(wh[1]);
            }
        })            
